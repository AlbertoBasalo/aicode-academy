...
description: "Las specs definen requerimientos y su verificación de manera formal y detallada. Bien, pero is el requisito cambia y te planteas qué hacer con el documento: ¿lo tiras, lo editas, o encadenas uno nuevo?"
slug: "mantener-especificaciones"
category: "procedimientos"
date: "2026-07-26"
---

Escribes la especificación, el agente genera el código, los tests pasan y haces la _release_. Tres días después el cliente pide que las reservas también notifiquen por email, y ahí se complica la metodología. ¿Qué haces con esa **spec** cuando el mundo cambia? Porque más temprano que tarde acaba cambiando.

Casi todos los _pipelines_ de **Spec-Driven Development** que circulan por ahí nacieron pensando en proyectos _greenfield_, donde cada petición es funcionalidad nueva y cada _spec_ estrena carpeta. Pero el software real es, o se vuelve enseguida, _brownfield_ , y las peticiones que llegan a partir de ahí casi nunca son _features_ nuevas.
