...
El [protocolo MCP](https://docs.github.com/es/copilot/concepts/about-mcp) permite a los modelos de IA **interactuar con herramientas externa en lenguaje natural**. Entre otras, puedes solicitar peticiones que incluyan acciones como estas:
...
- `Crea una issue en el repositorio "mi-repo" con el titulo "mi-issue"`

Todo, como ves, en lenguaje natural y de usando la herramienta de manera inteligente. Pero también puedes especificar su uso con un prompt.
...
La manera más sencilla de instalar un servidor MCP es usar el [market place de herramientas MCP](https://code.visualstudio.com/mcp) que permiten:
...
EL protocolo MCP te permite envolver cualquier servicio o incluso utilidades de terminal de forma que se ofrezca a clientes MCP (Copilot es un cliente MCP).
...
- **Instrucciones**: Define instrucciones para librerías, lenguajes, documentación, etc.
