...
## A los les gusta el texto, dales un buen lugar de trabajo.
...
Cuando lo básico ya está estable, entonces sí, busca y adapta skills para la limpieza. Te sugiero que eches un vistazo a [skills.sh](https://skills.sh/) y [awesome-copilot](https://github.com/github/awesome-copilot/) para ver las skills más populares. 
...
Ajusta y aplica rutinariamente las skills que te interesen tras cada sesión de programación. Poro a poco, el código (legado humano y robótico generado) se irá limpiando.
---
...
En mi opinión, sigue importando mucho. Incluso diría que más que nunca. Porque el código es la epressión de la solución a un problema en forma de texto.
